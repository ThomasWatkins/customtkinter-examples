...
side_img_data = Image.open("Login\side-img.png")
email_icon_data = Image.open("Login\email-icon.png")
password_icon_data = Image.open("Login\password-icon.png")
google_icon_data = Image.open("Login\google-icon.png")
